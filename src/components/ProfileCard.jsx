function ProfileCard() {
  ...
  return (
    <div className="border-2 px-8 py-10 flex justify-center items-center flex-col w-90 h-90 shadow-2xl rounded-lg border-blue-600 hover:border-blue-800 mt-10">
